...
#ifndef TIKTOKBUSINESSSDK_SWIFT_H
#define TIKTOKBUSINESSSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TikTokBusinessSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("TTStoreKitObserver") SWIFT_AVAILABILITY(ios,introduced=15.0)
@interface TikTokStoreKitObserver : NSObject
...
@interface TikTokStoreKitObserver (SWIFT_EXTENSION(TikTokBusinessSDK)) <SKPaymentTransactionObserver>
- (void)paymentQueue:(SKPaymentQueue * _Nonnull)queue updatedTransactions:(NSArray<SKPaymentTransaction *> * _Nonnull)transactions;
@end

@class NSString;
SWIFT_AVAILABILITY(ios,introduced=15.0)
@interface TikTokBusiness (SWIFT_EXTENSION(TikTokBusinessSDK))
- (void)trackStoreKit2PurchaseFailedWithProductId:(NSString * _Nonnull)productId;
@end
